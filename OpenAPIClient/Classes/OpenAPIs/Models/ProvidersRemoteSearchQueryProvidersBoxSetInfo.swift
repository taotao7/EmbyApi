//
// ProvidersRemoteSearchQueryProvidersBoxSetInfo.swift
//
...
public struct ProvidersRemoteSearchQueryProvidersBoxSetInfo: Codable, JSONEncodable, Hashable {

    public var searchInfo: ProvidersBoxSetInfo?
    public var itemId: Int64?
    public var searchProviderName: String?
    public var includeDisabledProviders: Bool?

    public init(searchInfo: ProvidersBoxSetInfo? = nil, itemId: Int64? = nil, searchProviderName: String? = nil, includeDisabledProviders: Bool? = nil) {
