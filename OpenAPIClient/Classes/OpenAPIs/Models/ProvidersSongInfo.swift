...
public struct ProvidersSongInfo: Codable, JSONEncodable, Hashable {
    ...
    public init(albumArtists: [String]? = nil, album: String? = nil, artists: [String]? = nil, name: String? = nil, metadataLanguage: String? = nil, metadataCountryCode: String? = nil, providerIds: [String: String]? = nil, year: Int? = nil, indexNumber: Int? = nil, parentIndexNumber: Int? = nil, premiereDate: Date? = nil, isAutomated: Bool? = nil) {
