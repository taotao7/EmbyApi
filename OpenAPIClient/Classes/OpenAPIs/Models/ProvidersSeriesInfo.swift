...
public struct ProvidersSeriesInfo: Codable, JSONEncodable, Hashable {
    ...
    public init(episodeAirDate: Date? = nil, name: String? = nil, metadataLanguage: String? = nil, metadataCountryCode: String? = nil, providerIds: [String: String]? = nil, year: Int? = nil, indexNumber: Int? = nil, parentIndexNumber: Int? = nil, premiereDate: Date? = nil, isAutomated: Bool? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(episodeAirDate, forKey: .episodeAirDate)
