...
// Gets a music genre, by name
MusicGenresServiceAPI.getMusicgenresByName(name: name, userId: userId) { (response, error) in
    guard error == nil else {
        print(error)
        return
    }
